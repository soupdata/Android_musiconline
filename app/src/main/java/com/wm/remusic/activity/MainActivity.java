...
public class MainActivity extends BaseActivity implements CardPickerDialog.ClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        isLogin = MainApplication.isLogin;
    }
    ...
    private void setLeftMenu() {
        ...
        View headView;
        if (!isLogin) {
             headView = inflater.inflate(R.layout.nav_header_main, null);
            mLvLeftMenu.addHeaderView(headView);
            mLvLeftMenu.setAdapter(new MenuItemAdapter(this));
            loginButton = (Button) headView.findViewById(R.id.login);
            loginButton.setOnClickListener(new View.OnClickListener() {
             ...
             headView = inflater.inflate(R.layout.nav_header_main_islogin, null);
            mLvLeftMenu.addHeaderView(headView);
            mLvLeftMenu.setAdapter(new MenuItemAdapter(this));
        }
